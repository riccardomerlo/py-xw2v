...
from pytorch.after_training_torch import  _full_loss_torch
...
if MODE == 'post':
  with open(output_dir+'data_v3.pkl', 'rb') as han: 
    data_v2 = pickle.load(han)
if MODE == 'train':
  with open(output_dir+'data_shuffle.pkl', 'rb') as han: 
    data_v2 = pickle.load(han)

with open(output_dir + 'vocab_v3.pkl', 'rb') as han:
  vocab_v2 = pickle.load(han)

with open(output_dir + 'inv_vocab_v3.pkl', 'rb') as han:
  inv_vocab_v2 = pickle.load(han)

with open(output_dir + 'unigram_counts_v3.pkl', 'rb') as han:
